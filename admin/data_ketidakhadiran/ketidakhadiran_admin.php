<?php
// FILE: admin/data_ketidakhadiran/ketidakhadiran_admin.php
...
// Mapping koneksi (Sinkron dengan pegawai)
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['simpan_ketidakhadiran'])) {
    ...
    if (!$keterangan || !$tanggal) {
        ...
        // Proses Upload File (Sinkron dengan folder pegawai)
        ...
        if ($pesanError === '') {
            ...
            if ($stmt->execute()) {
                // Redirect kembali ke daftar pengajuan admin
...
$judul = "Ajukan Ketidakhadiran Admin";
            ...
            <div class="col-12 col-md-8 col-lg-6">
                <div class="card shadow-sm">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h3 class="card-title mb-0">Ajukan Ketidakhadiran (Admin)</h3>
                    ...
                    <div class="card-body">
                        ...
                        <form action="" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                            ...
                            <div class="mb-3">
                                ...
                                <small class="form-hint">Format diizinkan: PDF, JPG, PNG.</small>
                            </div>
                            
                            <div class="form-footer">
                                <button type="submit" name="simpan_ketidakhadiran" class="btn btn-primary w-100">
                                    <i class="fe fe-send me-2"></i> Kirim Pengajuan
                                </button>
                            </div>
                        </form>

                    </div>
                    <div class="card-footer small text-muted text-center border-top-0">
                        Pengajuan Anda akan masuk ke daftar dengan status <strong>PENDING</strong> untuk direkam ke dalam sistem.
                    </div>
                </div>
            </div>
        </div>
